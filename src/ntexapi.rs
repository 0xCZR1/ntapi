...
STRUCT!{struct SYSTEM_DPC_WATCHDOG_INFORMATION {
    Flags: ULONG,
    SingleDpcTimeLimit: ULONG,
    CumulativeDpcTimeLimit: ULONG,
    SingleDpcSoftTimeLimit: ULONG,
    CumulativeDpcSoftTimeLimit: ULONG,
}}
pub type PSYSTEM_DPC_WATCHDOG_INFORMATION = *mut SYSTEM_DPC_WATCHDOG_INFORMATION;
STRUCT!{struct SYSTEM_DPC_WATCHDOG_INFORMATION2 {
    Flags: ULONG,
    SingleDpcTimeLimit: ULONG,
    CumulativeDpcTimeLimit: ULONG,
    SingleDpcSoftTimeLimit: ULONG,
    CumulativeDpcSoftTimeLimit: ULONG,
    SingleDpcWatchdogThreshold: ULONG,
    CumulativeDpcWatchdogThreshold: ULONG,
    DpcWatchdogProfileLength: ULONG,
}}
pub type PSYSTEM_DPC_WATCHDOG_INFORMATION2 = *mut SYSTEM_DPC_WATCHDOG_INFORMATION2;
...
STRUCT!{struct SYSTEM_PROCESSOR_FEATURES_BITMAP_INFORMATION {
    ExtendedFeatures0: ULONGLONG,
    ExtendedFeatures1: ULONGLONG,
}}
pub type PSYSTEM_PROCESSOR_FEATURES_BITMAP_INFORMATION = *mut SYSTEM_PROCESSOR_FEATURES_BITMAP_INFORMATION;
...
STRUCT!{struct SYSTEM_TRUSTED_APPS_RUNTIME_INFORMATION {
    Flags: ULONGLONG,
    Information: ULONGLONG,
}}
pub type PSYSTEM_TRUSTED_APPS_RUNTIME_INFORMATION = *mut SYSTEM_TRUSTED_APPS_RUNTIME_INFORMATION;
...
STRUCT!{struct SYSTEM_SECURITY_MODEL_INFORMATION {
    SecurityModelInformation: ULONG,
}}
pub type PSYSTEM_SECURITY_MODEL_INFORMATION = *mut SYSTEM_SECURITY_MODEL_INFORMATION;
...
STRUCT!{struct SYSTEM_POOL_ZEROING_INFORMATION {
    PoolZeroingEnabled: BOOLEAN,
}}
...
STRUCT!{struct SYSTEM_SECURE_SPECULATION_CONTROL_INFORMATION {
    Flags: ULONG,
    Reserved: ULONG,
}}
pub type PSYSTEM_SECURE_SPECULATION_CONTROL_INFORMATION = *mut SYSTEM_SECURE_SPECULATION_CONTROL_INFORMATION;
